...
1. `_` - 17 edges
2. `Audit Temuan — selesai ✅` - 17 edges
3. `BAGIAN B — SELESAI (arsip) — urutan bawah` - 15 edges
4. `11 — Security & Privacy (Mobile — mirumobileapp)` - 13 edges
5. `MIRU Bank Sampah — Mobile App (Miru-G)` - 13 edges
6. `04 — API Integration (Mobile)` - 11 edges
7. `Ringkasan Aturan untuk UI Mobile` - 11 edges
8. `08 — Task List: Mobile App Development Roadmap` - 11 edges
9. `12 — Play Console Internal Testing (Staging untuk Stakeholder)` - 11 edges
10. `_HomeScreenState` - 10 edges
...
Cohesion: 0.07
Nodes (27): Color get, dijadwalkan,
  dalamPerjalanan,
  dijemput,
...
Cohesion: 0.06
Nodes (28): dart:async, dart:convert, dart:typed_data, Duration?, HttpClientAdapter, package:flutter_test/flutter_test.dart, package:mirumobileapp/app.dart, package:mirumobileapp/models/user.dart (+20 more)
...
Cohesion: 0.05
Nodes (39): NumberFormat get, package:geolocator/geolocator.dart, _alamatController, _ambilLokasi, _beratController, build, _buildInfoHeader, category (+31 more)

### Community 35 - "Community 35"
Cohesion: 0.10
Nodes (20): AnimationController, _animation, borderRadius, build, child, _controller, createState, dispose (+12 more)
...
Cohesion: 0.08
Nodes (25): AuthService, config/routes.dart, _apiClient, _authProvider, _authService, _authSession, build, createState (+17 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (26): ../models/withdrawal.dart, _activeFilter, _apiClient, clearCache, clearError, clearSubmitError, createWithdrawal, _currentUserId (+18 more)
...
Cohesion: 0.09
Nodes (21): hargaTidakSesuai,
  petugasTidakDatang,
  kesalahanData,
  buktiTidakMuncul,, apiValue, Complaint, ComplaintStatus, displayLabel, ditutup, fromApiValue, fromJson (+13 more)
...
Cohesion: 0.07
Nodes (28): alamat, avatarUrl, copyWith, dateJoined, fromJson, hasCompleteAddress, id, isActive (+20 more)
...
Cohesion: 0.08
Nodes (23): ../../models/activity_item.dart, ../models/json_parsing.dart, _apiClient, _categories, clearCache, _error, _fetchDashboard, fetchEarliestUpcomingTanggalBerlaku (+15 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (46): api_client.dart, Dio, Future, AuthInterceptor, authSession, _clearSession, interceptors/auth_interceptor.dart, _doRefresh (+38 more)
...
Cohesion: 0.12
Nodes (16): 8.1 Modul 2 — Autentikasi lanjutan, Audit Temuan — selesai ✅, Dari Fase 8: Pengembangan Lanjutan, M0. Navigasi & cache (umum), M10. Modul 17 — Settings mobile, M1. Modul 2 — Auth OTP WA + register singkat, M1. Modul 2 — Auth, register, reset password, M2. Modul 3 / 15 — Kartu digital & QR Home (+8 more)
...
Cohesion: 0.08
Nodes (24): _applyFieldErrors, _clearFieldErrors, createState, dispose, _extractError, _fieldErrorOtp, _fieldErrorPhone, _fieldErrorUsername (+16 more)

### Community 88 - "Community 88"
Cohesion: 0.12
Nodes (15): miru_logo.dart, asset, body, build, buttonLabel, _IllustrationHero, imageAsset, OnboardingScaffold (+7 more)
...
Cohesion: 0.18
Nodes (10): bool get, AuthSession, clearSession, _isLoggedIn, _needsPhoneVerification, refresh, setLoggedIn, setNeedsPhoneVerification (+2 more)
